...
def gen_deconv(lvl1_fname_list, lvl1_path, lvldec_path=None):
    if lvldec_path is None:
        lvldec_path = lvl1_path
    ...
    m_decov.save(lvldec_path+'/'+new_name)
...
if __name__ == '__main__':
    ...
    lvl1p5_path = 'AIA_data/171A_lvl1.5/'
    lvldec_path = 'AIA_data/171A_dec/'
    ...
    while aia_files_samp:
        aia_files_samp = gen_deconv(aia_files_samp, lvl1_path,lvldec_path)
